...
import { getTrustLadderLevel, getTrustPromptCopy } from "@/lib/trust-ladder";
...
export default async function MemberProfilePage({
  ...
  const viewerTrustLevel = getTrustLadderLevel(viewer);
  ...
  const chatBlockedByEmail = !viewerEmailVerified;
  ...
  const chatTrustPrompt = getTrustPromptCopy(viewerTrustLevel, "chat");
  const videoTrustPrompt = getTrustPromptCopy(viewerTrustLevel, "video");
  ...
  const actionPanel = isOwner ? (
    ...
    <div className="rounded-[1.4rem] border border-[rgba(255,255,255,0.08)] bg-[radial-gradient(circle_at_top_left,rgba(189,151,100,0.06),transparent_36%),rgba(255,255,255,0.026)] p-4 text-sm text-white/72" data-testid="profile-action-panel">
    ...
    <section className="space-y-3" data-testid="profile-action-panel">
      ...
      <div className="rounded-[1.35rem] border border-[rgba(255,255,255,0.08)] bg-[radial-gradient(circle_at_top_left,rgba(189,151,100,0.06),transparent_36%),rgba(255,255,255,0.026)] p-4 text-sm text-white/72">
            ...
            : featuredCapState?.blocked
              ...
              : chatBlockedByPolicy
                ...
                : chatNeedsVerification
                  ...
                  : chatTrustPrompt ?? "Start with a quiet request and move the conversation privately from there."}
        ...
        <div className="mt-4">
          ...
          ) : isBlocked || (!featuredTrustAccess.allowed && activeFeatureForProfile) || featuredCapState?.blocked || chatBlockedByEmail || chatBlockedByPolicy || chatNeedsVerification ? (
      ...
      <div className="rounded-[1.35rem] border border-[rgba(255,255,255,0.08)] bg-[radial-gradient(circle_at_top_left,rgba(189,151,100,0.06),transparent_36%),rgba(255,255,255,0.026)] p-4 text-sm text-white/72">
        ...
        <p className="mt-2 leading-6">
          ...
          {!videoTrustAccess.allowed
            ...
            : !hasActiveConversation
              ...
              : videoTrustPrompt ?? "Video needs separate approval and can still be revoked at any time."}
        ...
        <div className="mt-4">
          ...
          ) : isBlocked || !hasActiveConversation || !viewerEmailVerified || !videoTrustAccess.allowed ? (
          ...
          <>
            ...
            <section className="grid gap-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.9fr)]">
              ...
              <section className="space-y-4">
                ...
                <div className="rounded-[1.6rem] border border-[rgba(255,255,255,0.08)] bg-[linear-gradient(180deg,rgba(56,45,40,0.9),rgba(43,35,31,0.94))] p-5 text-white shadow-[0_14px_30px_rgba(18,12,9,0.12)]">

                  <p className="text-sm leading-7 text-white/74">{user.bio ?? "Nothing more is shared here yet. The profile stays intentionally light until more context feels right."}</p>
                    ...
                    <div>
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        {sharedGroups.length === 0 ? (
                          ...
                          <p className="leading-6 text-white/58">No shared circles to show yet. If you cross paths later, they will appear here quietly.</p>
              ...
              <div className="grid gap-4 lg:grid-cols-3">
                ...
                {recentPosts.length === 0 ? (
                  ...
                  <div className="rounded-[1.5rem] border border-dashed border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.03)] px-4 py-6 text-sm text-white/58">
                    ...
                    No recent visible posts yet. When this member shares something, it will show up here.
