  ...
  return (
    <div className="mb-3 flex flex-wrap items-start justify-between gap-3 rounded-[1rem] border border-[color:rgba(124,74,110,0.14)] bg-[color:var(--lux-highlight-soft)] px-4 py-3 text-sm text-[color:var(--lux-text-secondary)] shadow-[0_10px_22px_rgba(43,43,43,0.035)]">
      <div className="flex min-w-0 items-start gap-3">
        <span className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[rgba(255,255,255,0.06)] text-[color:var(--lux-accent-deep)] shadow-[0_6px_14px_rgba(7,8,10,0.12)]">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-[color:var(--lux-border)] bg-[rgba(255,255,255,0.04)] text-[color:var(--lux-text-muted)] transition hover:text-[color:var(--lux-text)] disabled:opacity-60"
          disabled={isPending}
